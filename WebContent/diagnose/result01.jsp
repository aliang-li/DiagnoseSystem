...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="85%" height="72"><table width="100%" height="60" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="1075"><span class="STYLE4">首页</span> <span class="STYLE4">&gt; 小肠癌AI辅助分割</span></td>
        ...
        <td width="593" height="100" bordercolor="#F0F0F0" bgcolor="#FFFFFF"><table width="397" height="70" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="248"><div align="center" class="STYLE5">
              <div align="left"><a href="../test3D/test3D.jsp?niiName=test.nii.gz" target="_blank">查看原数据的3D效果</a></div>
            </div></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td height="100" bgcolor="#FFFFFF"><table width="397" height="70" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="33">&nbsp;</td>
            <td width="248"><div align="center" class="STYLE5">
                <div align="left"><a href="../test3D/test3D.jsp?niiName=merge.nii.gz" target="_blank">查看分割后的3D效果</a></div>
            </div></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td height="100" bgcolor="#FFFFFF"><table width="397" height="70" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="33">&nbsp;</td>
            <td width="248"><div align="center" class="STYLE5">
                <div align="left"><a href="getResultNii.action">下载分割后的nii文件</a></div>
            </div></td>
          </tr>
        </table></td>
      </tr>
