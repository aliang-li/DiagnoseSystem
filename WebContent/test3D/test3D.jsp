...
<html> 
  ...
  <%!File file = null;%>
   ...
   <%--  <%!String path = "E:\\dicom-examples\\md65";%> --%>
    ...
    String str="";
    if(niiName.equals("merge.nii.gz")){
    	str = "http://222.24.62.190:8090/three1/"+user.getLoginname()+"/"+niiName;
    }else{
    	str = "http://222.24.62.190:8090/three2/"+user.getLoginname()+"/"+niiName;
    }
    ...
    <div id="sliceX"   style="border-top: 2px solid red; border-right: 1px solid #666666; background-color: #252525; width: 24.3%; height: 31.5%; float: left; text-align:center; font-size:13px; color:#ffffff;position:static;">矢状面-X轴</div>
