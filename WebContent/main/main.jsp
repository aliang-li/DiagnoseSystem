  ...
  <tr>
    ...
    <table width="100%" height="361" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="33%" height="361">
          ...
          <tr>
            ...
            <a href="http://222.24.62.190:8090/SH/upload/upload.jsp?typeName=intestineDetection&&name=小肠癌AI辅助诊断">小肠癌AI辅助诊断</a></div></td>
          </tr>
        ...
        <td width="30%"><table width="330" height="243" border="0" cellpadding="0" cellspacing="0"  background="../images/miantan1.png">
          <tr>
            <td><div align="center" class="STYLE3"><a href="http://222.24.62.190:8090/SH/upload/upload.jsp?typeName=intestineSegment&&name=小肠癌AI辅助分割">小肠癌AI辅助分割</a></div></td>
          </tr>
          
        </table></td>
        <td width="40%"><table width="330" height="243" border="0" cellpadding="0" cellspacing="0"  background="../images/miantan1.png">
          <tr>
            <td><div align="center" class="STYLE3"><a href="http://222.24.62.190:8090/SH/upload/uploadmt.jsp?typeName=facialDetection&&name=面瘫AI辅助诊断">面瘫AI辅助诊断</a></div></td>
          </tr>
      ...
      <tr>
          ...
          <tr>
            <td> <div align="center" class="STYLE3">
            <a href="http://222.24.62.190:8090/SH/upload/upload.jsp?typeName=lymphomaDetection&&name=淋巴癌AI辅助诊断">淋巴癌AI辅助诊断</a></div></td>
          </tr>
